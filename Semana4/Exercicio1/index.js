  ...
  exibirDados() {
    this.resultado.innerHTML = `<h3>Dados Cadastrados</h3>
              ...
              <p><strong>Data de Nascimento:</strong> ${
                this.campos.dataNascimento.value
              }</p>
              <p><strong>Telefone Celular:</strong> ${
                this.campos.telefoneCelular.value
              }</p>
              <p><strong>Tipo:</strong> ${
                this.tipoProfessor.checked ? "Professor" : "Aluno"
              }</p>
              <p><strong>${
                this.tipoProfessor.checked ? "Área" : "Curso"
              }:</strong> ${this.campos.areaCurso.value}</p>
              <p><strong>Matrícula:</strong> ${
                this.campos.matricula.value
              }</p>`;
...
document.addEventListener("DOMContentLoaded", () => {
  new FormularioCadastro("formularioDeCadastro");
});
